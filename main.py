...
def main():
    ...
    if ENABLE_SOCKET:
        ...
        client_socket.connect(("192.168.137.139", 12358))

    # Set image detection model
    od = ObjectDetection(model="imageRecognition/imageModels/newbest.pt", detection_mode=DetectionMode.CAMERA, capture_index=5)
